...
This page analyses responses to the survey question: *"Have you ever stopped learning English? If so, what were the main obstacles?"*

The free-text responses were analysed and labelled by an LLM (Large Language Model) to identify common obstacle categories.
...
print("The table below shows each obstacle with how many respondents mentioned it, plus a detailed explanation of common themes in their answers.")
print()
