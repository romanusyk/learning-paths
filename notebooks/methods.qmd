...
This chart shows how our respondents assessed the effectiveness of each learning method. For each learning method, the popularity of each ratings (1-5 scale) is shown. Respondents rated the effectiveness of these methods:
...
This chart shows how our respondents assessed the engagement of each learning method. For each learning method, the popularity of each ratings (1-5 scale) is shown. Respondents rated the engagement of these methods:
...
Combining the assessment of the effectiveness and engagement of each method, this chart shows the average ratings for the methods, side by side:
